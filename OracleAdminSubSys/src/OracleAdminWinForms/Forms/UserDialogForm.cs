...
{
    private readonly TextBox _txtUsername = UiHelper.CreateTextBox();
    private readonly TextBox _txtPassword = UiHelper.CreateTextBox("", true);
    private readonly TextBox _txtDefaultTs = UiHelper.CreateTextBox("USERS");
    private readonly TextBox _txtTempTs = UiHelper.CreateTextBox("TEMP");
    ...
    public UserDialogForm(string title, bool isEditPasswordOnly = false, string? username = null)
    {
        ...
        _btnOk.Click += (_, _) =>
        {
            ...
            {
                UiHelper.ShowInfo("Vui lòng nhập username và password.");
                return;
            }
